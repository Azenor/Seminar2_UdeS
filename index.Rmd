...
### Azenor Bideault, .small[PhD candidate <br> Supervised by Dominique Gravel and Michel Loreau]
...
<br><br><br>
.center[Variation in structure and dynamics]
...
# What shapes community structure and dynamics ?
...
.center[
On the dynamics of consumer-resource systems
...
.center[
On the structure of consumer-resource systems
...
# How does temperature shape communities ?
## A cross-scales perspective
<hr width="100%" align="left" size="0.3" color="orange"></hr>
...
.center[
![:scale 90%](images/temp_trophic_interactions.svg)]

.center[

- Consumer-resource interactions
- Compare marine and terrestrial ecosystem
]
...
\dfrac{dB_i}{dt} &= g_iB_i + \epsilon A_{ji}B_iB_j - q_iB_i - D_iB_i^2
\end{align}
$$
...
.center[![:scale 80%](images/schema_recap1.png)]
...
.center[![:scale 80%](images/schema_recap4.png)]
...
--
.center[**How do they affect trophic interactions and hence community dynamics and structure ?**]
...
- Effect of the latitudinal gradient
- Effect of warming

On trophic control and stability
...
<br>
.center[**To infer their structural and dynamical properties**]
...
.center[**What about self-regulation ?**]

---
# Self-regulation
.small[(i.e the dark matter of ecology)]
...
- λ : trophic control (bottom-up vs top-down)
- Biomass total
- Variability : means species biomass variance (temporal variance in response to stochastic pertubations)
...
---
# Dynamical properties at large scale

.pull-left[Trophic control
![](images/map_lambda.png)]

.pull-right[Biomass total
![](images/map_sum_biom.png)]

.center[
![](images/map_collectivitypng)]

---
# Dynamical properties according to the number of species

.center[![:scale 60%](images/nbspecies.svg)]

---
# Dynamical properties according to temperature

.center[![:scale 60%](images/temp_control.svg)]

---
# Effect of warming on dynamical properties

.center[![:scale 70%](images/temp_control_warming.png)]

---
# Effect of warming on dynamical properties

.center[![:scale 60%](images/heat_diff.svg)]

---
# Effect of warming on dynamical properties

.center[Difference in species biomass with warming for each trophic level
![](images/heat_hist.svg)]

---
# Conclusion

- Effect of the number of species
- Effect of the temperature gradient on collectivity
- Low impact of warming on community properties
  - except on collectivity
- Warming affects species biomass intra-community
  - especially 2nd and 3rd trophic levels
...
- No variation in activation energies
