...
---
# Effects of temperature on food chain structural properties
...
.pull-right1[![:scale 70%](images/BAfunction_mismatch.png) <br>
...
.center[![:scale 50%](images/global_warming.jpg)]
...
The temperature gradient alone does not seem to affect community properties (except collectivity) <br>
...
.center[Warming does not strongly affect community properties, except collectivity.
Interactive effect of the temperature gradient with warming.]
...
- Effect of the number of species on λ and collectivity
  - Could explain the latitudinal variation of trophic control
- Temperature gradient and warming affects collectivity but not significantly other community properties

**Warming seems to affect individual species more than communities as an entity**
...
- No variation in activation energies (but same group taxonomic)
...
- Trophic control and collectivity are affected by number of species
  - Latitudinal gradient mostly driven by changes in number of species

**Warming seems affect individual species biomasses, but not significantly community properties**
